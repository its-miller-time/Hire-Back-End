...
cursor.execute('''
SELECT nameFirst, accepted, description,most_recent_job_role,desired_location_city,desired_salary_range,years_of_experience
FROM candidates
''')
...
candiadte_df.columns = ["name","accepted","description","title","location","salary_range","years_of_experience"]
...
cursor.execute('''
SELECT candidates.id, candidates.nameFirst, skill
